...
public class Elev extends Aplicant{
	...
	private static int valoare_fin_elev = 30;
	...
	public static void setValoareFinantareElev(int valoareFinantareElev) {
		valoare_fin_elev = valoareFinantareElev;
	}
	...
	public void afiseazaFinantare() {
		System.out.println("Elevul "+getNume()+" "+getPrenume()+" primeste "+Elev.valoare_fin_elev+" Euro/zi in proiect.");
	}
